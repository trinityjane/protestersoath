...
import 'app_drawer/app_drawer_bloc.dart';
import 'app_drawer/app_drawer_event.dart';
            ...
            child: Expanded(
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  MenuItem(AppLocalizations.of(context)!.verifyAnOath,
                      Icons.open_in_full, () {
                    BlocProvider.of<AppDrawerBloc>(context)
                        .add(VerifyPageEvent());
                    Navigator.pop(context);
                  ...
                  MenuItem(
                      AppLocalizations.of(context)!.stories, Icons.art_track,
                      () {
                    BlocProvider.of<AppDrawerBloc>(context)
                        .add(StoryPageEvent());
                    Navigator.pop(context);
                  }),
                  MenuItem(AppLocalizations.of(context)!.protests,
                      Icons.announcement, () {
                    BlocProvider.of<AppDrawerBloc>(context)
                  ...
                  MenuItem(
                      AppLocalizations.of(context)!.logout, Icons.exit_to_app,
                      () {
